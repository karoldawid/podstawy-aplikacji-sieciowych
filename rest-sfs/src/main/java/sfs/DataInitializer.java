    ...
    public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            SportsFacility basen = sportsFacilityService.createSwimmingPool(
                    new CreateSwimmingPoolRequest(
                            "Pływalnia \"Pingwin\"",
                            20.0,
                            50,
            ...
            SportsFacility sond = sportsFacilityService.createTennisCourt(
                    new CreateTennisCourtRequest(
                            "Sąd okręgowy",
                            30.0,
                            4,
            ...
            User clientMvc1 = userService.createClient(
                    new CreateClientRequest("NDAA", " ALE_TEN_WERS", "KOSZTOWAL")
            );

            User clientMvc2 = userService.createClient(
                    new CreateClientRequest("WIEEELE", "BBL_ONA", "TO_WOLI_NIZ")
            );

            userService.activateUser(client1.getId());
            userService.activateUser(client2.getId());
            userService.activateUser(clientMvc1.getId());
            userService.activateUser(clientMvc2.getId());
